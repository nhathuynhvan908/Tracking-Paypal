<?php
/**
 * Class DEVVP_WC_Email_Customer_Partial_Shipped_Order file.
 *
...
if ( ! class_exists( 'DEVVP_WC_Email_Customer_Partial_Shipped_Order', false ) ) :
	 ...
	 *
	 * @class       DEVVP_WC_Email_Customer_Partial_Shipped_Order
	 * @extends     WC_Email
	 */
	class DEVVP_WC_Email_Customer_Partial_Shipped_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->template_html  = 'email/customer-partial-shipped-order.php';
			$this->template_plain = 'email/plain/customer-completed-order.php';
		...
		public function get_content_html() {
			...
			if ( file_exists( $local_file ) && is_writable( $local_file )) {							
				...
				return wc_get_template_html(
					'email/customer-partial-shipped-order.php',
					array(
						'order'              => $this->object,
						'email_heading'      => $this->get_heading(),
						'additional_content' => $this->get_additional_content(),
...
return new DEVVP_WC_Email_Customer_Partial_Shipped_Order();
